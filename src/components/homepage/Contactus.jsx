...
export default function CallToAction() {
  return (
    <section className="max-w-7xl mx-auto rounded-2xl px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12 bg-gradient-to-r from-purple-600 via-purple-600 to-purple-700 mb-8 sm:mb-10 md:mb-12">
